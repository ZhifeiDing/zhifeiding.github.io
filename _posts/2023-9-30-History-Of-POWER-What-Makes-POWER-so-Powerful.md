...
![Pasted image 20230914090918.png](/assets/images/power/Pasted image 20230914090918.png)
  ...
  The memory bus operates at twice the DRAM frequency and scales with DRAM frequency. POWER5 chips on the MCM are interconnected with two buses in a ring configuration, with data flowing in opposite directions on the two buses. Each of these buses is 8 bytes wide and operates at processor frequency.
...
# 8. POWER 6
**POWER6** 是一个双核，每核双线程的顺序处理器，增加了虚拟化，十进制算术运算，向量多媒体运算功能，并且实现了Checkpoint retry 和 处理器冗余功能。*recovery unit (RU)* 保存处理器的状态，并且使用ECC保护，当发生错误时，处理器使用这些状态恢复。下图展示了**POWER6**的die shot:

![Pasted image 20230726195941.png](/assets/images/power/Pasted image 20230726195941.png)

## 8.1 POWER6 Core Pipeline
